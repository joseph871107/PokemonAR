...
if [ -f ../PokemonAR/TFLite/${MOBILENETV1_SSD_NAME} ]
then
...
if [ -f ../PokemonAR/TFLite/${EFFICIENTDET_LITE0_NAME} ]
then
...
if [ -f ../PokemonAR/TFLite/${EFFICIENTDET_LITE1_NAME} ]
then
...
if [ -f ../PokemonAR/TFLite/${EFFICIENTDET_LITE2_NAME} ]
then
...
if ${has_download}
then
cp ${DOWNLOADS_DIR}/models/* ../PokemonAR/TFLite
rm -rf ${DOWNLOADS_DIR}
fi
